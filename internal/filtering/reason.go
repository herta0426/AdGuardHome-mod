...
const (
	...
	// reason.
	//
	// It's appended to the end of the list instead of being put next to the
	// other filtered reasons to keep the numbers of the existing ones stable,
	// since they are stored in the query log and statistics files.
	FilteredSNI
)
